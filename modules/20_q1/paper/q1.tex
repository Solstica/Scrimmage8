...
忽略层间接触热阻，在两个材料界面$x=x_1=d_1$和$x=x_2=d_1+d_2$处满足温度连续与热流连续：
\begin{equation}
\left\{
\begin{aligned}
&T_i(x_j^{-},t)=T_{i+1}(x_j^{+},t),\\
&k_i\frac{\partial T_i}{\partial x}(x_j^{-},t)
=k_{i+1}\frac{\partial T_{i+1}}{\partial x}(x_j^{+},t),
\end{aligned}
\right.
\qquad j=1,2.
